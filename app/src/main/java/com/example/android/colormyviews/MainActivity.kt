...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Attach listeners to all the views.
     */
    private fun setListeners(){
        // import kotlinx.android.synthetic.main.activity_main.*
        // enables accessing views directly by their id, similar to data binding
        // but with less setup code.
        // In build.gradle file for app the plugin section must contain:
